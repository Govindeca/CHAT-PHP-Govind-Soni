...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
    ...
    <div class="w3-display-middle w3-center">
        <span class="w3-text-white w3-hide-small" style="font-size:100px">Cuisine !<br>Taste of India !</span>
...
<footer class="w3-center w3-black w3-padding w3-xxlarge">
    <p>Welcome !<a href="index.php" class="w3-hover-text-green">Taste of India</a></p>
</footer>
